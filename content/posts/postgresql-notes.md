...
For more information see: [PostrgreSQL Aggregation Functions Documentation](https://www.postgresql.org/docs/current/static/functions-aggregate.html)
...
For more information see: [PostgreSQL SubQuery Expressions Documentation](https://www.postgresql.org/docs/current/static/functions-subquery.html)
...
* [PostgreSQL Views and the Rule System Documentation](https://www.postgresql.org/docs/current/static/rules-views.html)
...
For more information see: [PostgreSQL Windowing Function Expressions Documentation](https://www.postgresql.org/docs/current/static/functions-window.html)
